...
class Detector:
    ...
    def load(self, cam_para_file):
        ...
        self.model = YOLO('/home/esad/Desktop/coding/UAV-control-software/image_processing/pretrained/yolov8m.pt')
...
def image_process_main(shared, isTest):
    ...
    video_out = cv2.VideoWriter('/home/esad/tracking.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (width, height))

    #cv2.namedWindow("demo", cv2.WINDOW_NORMAL)
    #cv2.resizeWindow("demo", width, height)

    cam_para_path = "/home/esad/Desktop/Coding/UAV-control-software/image_processing/demo/cam_para.txt"
    detector = Detector()
